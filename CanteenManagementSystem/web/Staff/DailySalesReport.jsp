        ...
        <table id="reports">
            <tr>
                <td colspan="5">
                    ...
                    <h1 style="align:center;padding:50px;text-align:center">Daily Meal Sales Report </h1>
            ...
            <tr>
                ...
                <th style="text-align:center">Meal Category</th>
                <th style="text-align:center">Meal Price (RM)</th>
            </tr>
        ${output}
            <tr>

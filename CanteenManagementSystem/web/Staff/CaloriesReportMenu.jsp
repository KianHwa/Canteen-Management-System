    ...
    <body>
        ...
        <div class="reporttitle">
            <h1>Student Total Calories Intake Report</h1>
        </div>
      <form action="../CaloriesIntakeReport" method="POST" class="reports" id="reports" target="_blank">
        <div class="row">
          <div class="col-25">
            <label for="studid">Student ID</label>
          </div>
          <div class="col-75">
              <input type="text" id="studid" name="studid" placeholder="Enter Student ID">
          </div>
        </div>
